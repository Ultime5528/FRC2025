...
class AlignWithReefSide(DeferredCommand):
    ...
    @staticmethod
    def offsetTagPositions(tag_pos: Pose2d, backwards_offset: float, left_offset: float):
        flipped_tag = Pose2d(tag_pos.translation(), tag_pos.rotation() + Rotation2d.fromDegrees(180))
