...
class USparkMaxSim:
    def __init__(self, spark_max: SparkMax):
        ...
        self.sim_device_relative_encoder = SimDeviceSim(f"SPARK MAX [{spark_max.getDeviceId()}] RELATIVE ENCODER")
        self.sim_device_absolute_encoder = SimDeviceSim(f"SPARK MAX [{spark_max.getDeviceId()}] ABSOLUTE ENCODER")
        ...
        self._position_relative_encoder = self.sim_device_relative_encoder.getDouble("Position")
        self._velocity_relative_encoder = self.sim_device_relative_encoder.getDouble("Velocity")

        self._position_absolute_encoder = self.sim_device_absolute_encoder.getDouble("Position")
        self._velocity_absolute_encoder = self.sim_device_absolute_encoder.getDouble("Velocity")
