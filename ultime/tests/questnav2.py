...
class QuestNav:
    ...
    def __init__(self):
        ...
        self.pose3d_proto = geometry3d_pb2.ProtobufPose2d()
    ...
    def get_battery_percent(self) -> int:
        ...
        if not raw_data:
            return -1
        try:
            latest_device_data = data_pb2.ProtobufQuestNavDeviceData.FromString(raw_data)
    ...
    def command_periodic(self):
        ...
        latest_command_response = commands_pb2.ProtobufQuestNavCommandResponse.FromString(raw_response)
